    ...
    public class BatchController : Controller
    {
        ...
        public BatchController()
        {
            if (students == null)
            {
                ...
                {
                new Student() { Id =1, Name="Abhinav", Batch="B001", DateOfBirth= DateTime.Parse("19/04/2002"), Address = "Delhi" },

                new Student() { Id =2, Name="Saurav", Batch="B001",DateOfBirth= DateTime.Parse("20/10/2003"), Address = "Noida" },
